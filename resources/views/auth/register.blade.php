...
<div class="container-fluid" style="background-image: url(https://seringjalan.com/wp-content/uploads/2020/05/kota-Pengaraian.jpg); background-size: cover; background-position: center; height: 100vh;">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('register') }}" method="POST">
                        ...
                        <div class="form-group">
                            <input type="text" name="name" placeholder="Inputkan Nama" required>
                        </div>
                        <div class="form-group">
                            <input type="email" name="email" placeholder="Inputkan Email" required>
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" placeholder="Inputkan Password" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ url('login') }}" class="btn btn-secondary">Kembali ke Login</a>
                        </div>
                    </form>
                </div>
            </div>
