...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://smarttourism.pekanbaru.go.id/assets/vendors/bootstrap/css/bootstrap.min.css"
        media="all">
    <!-- Fonts Awesome CSS -->
    <link rel="stylesheet" type="text/css"
        href="https://smarttourism.pekanbaru.go.id/assets/vendors/fontawesome/css/all.min.css">
    <!-- jquery-ui css -->
    <link rel="stylesheet" type="text/css"
        href="https://smarttourism.pekanbaru.go.id/assets/vendors/jquery-ui/jquery-ui.min.css">
    <!-- modal video css -->
    <link rel="stylesheet" type="text/css"
        href="https://smarttourism.pekanbaru.go.id/assets/vendors/modal-video/modal-video.min.css">
    <!-- light box css -->
    <link rel="stylesheet" type="text/css"
        href="https://smarttourism.pekanbaru.go.id/assets/vendors/lightbox/dist/css/lightbox.min.css">
    <!-- slick slider css -->
    <link rel="stylesheet" type="text/css" href="https://smarttourism.pekanbaru.go.id/assets/vendors/slick/slick.css">
    <link rel="stylesheet" type="text/css"
        href="https://smarttourism.pekanbaru.go.id/assets/vendors/slick/slick-theme.css">
    <!-- google fonts -->
    <link
    ...
    <!-- Bar Rating -->
    <link rel="stylesheet"
        href="https://smarttourism.pekanbaru.go.id/assets_be/plugins/jquery-bar-rating-master/dist/themes/fontawesome-stars.css">

    <!-- Leaflet Map -->
    <link rel="stylesheet" href="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet/leaflet.css" />
    <link rel="stylesheet"
        href="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet.markercluster/dist/MarkerCluster.css" />
    <link rel="stylesheet"
        href="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet.markercluster/dist/MarkerCluster.Default.css" />
    <link rel="stylesheet"
        href="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet.locatecontrol/dist/L.Control.Locate.min.css" />
    <link rel="stylesheet"
        href="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet.fullscreen/dist/leaflet.fullscreen.css" />
    <link rel="stylesheet"
        href="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet.search/dist/leaflet-search.min.css" />
...
<body class="home">
    <div id="page" class="full-page">
            ...
            <div class="bottom-header">
                <div class="container d-flex justify-content-between align-items-center">
                    <div class="site-identity">
                        <h1 class="site-title">
                            <img src="https://rokanhulukab.go.id/rohul-content/uploads/logo_kabupaten_rokan_hulu.png"
                                alt="Logo Header" style="margin-top: 6%;" width="53px">
        ...
        <div class="container-fluid"
            style="background-image: url(https://seringjalan.com/wp-content/uploads/2020/05/kota-Pengaraian.jpg); background-size: cover; background-position: center; height: 100vh;">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5">
                            <aside class="widget widget_text">
                                <div class="award-img">
                                    <img src="https://rokanhulukab.go.id/rohul-content/uploads/logo_kabupaten_rokan_hulu.png"
                                        alt="Logo Header" width="70px">
                                    <img src="https://smarttourism.pekanbaru.go.id/assets/images/logo_WI.png"
                                        alt="Logo WI" width="42.5%">
                                </div>
                            </aside>
                        </div>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#">
                                                ...
                                                Jl. A Rahman Hamid, Komplek Perkantoran Tenayan Raya Gedung B6 Lantai 4
                                                Pekanbaru
                                            </a>
                                        </li>
                                    </ul>
        ...
        <div class="header-search-form">
            <div class="container">
                <div class="header-search-container">
                    <form action="https://smarttourism.pekanbaru.go.id/search" class="search-form" role="search"
                        method="get">
    ...
    <!-- Bar Rating -->
    <script
        src="https://smarttourism.pekanbaru.go.id/assets_be/plugins/jquery-bar-rating-master/dist/jquery.barrating.min.js">
    </script>

    <!-- Leaflet Map -->
    <script src="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet/leaflet.js"></script>
    <script
        src="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet.markercluster/dist/leaflet.markercluster.js">
    </script>
    <script
        src="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet.markercluster.layersupport/dist/leaflet.markercluster.layersupport-src.js">
    </script>
    <script src="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet.locatecontrol/dist/L.Control.Locate.min.js">
    </script>
    <script src="https://smarttourism.pekanbaru.go.id/assets_be/plugins/leaflet.fullscreen/dist/Leaflet.fullscreen.min.js">
    </script>
    ...
    <script type='text/javascript'
        src='https://platform-api.sharethis.com/js/sharethis.js#property=6192b41c1e3283001314a026&product=sop'
        async='async'></script>
</body>
